<x-app-layout>
    ...
    <div class="modal fade" id="infoAddPc" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                ...
                <div class="modal-body pt-0 text-muted" style="font-size:.9rem;">
                    Todos los componentes usados en el armado se quitarán del stock y se asignarán a la PC automáticamente.
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body pt-0">
                    <div class="d-flex flex-column gap-1 mb-3">
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Nº Inventario</span>
                            <span id="idenInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Nombre</span>
                            <span id="nombreInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">IPv4</span>
                            <span id="ipInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" id="titleAsig" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;"></span>
                    ...
                    <div class="d-flex flex-column gap-1">
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Placa madre</span>
                            <span id="motherInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Procesador</span>
                            <span id="proceInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Discos</span>
                            <span id="discosInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">RAMs</span>
                            <span id="ramsInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Fuente</span>
                            <span id="fuenteInfo" style="font-size:.9rem;"></span>
                        </div>
                        <div class="d-flex gap-2 align-items-baseline">
                            <span class="fw-semibold" style="font-size:.82rem;color:var(--hu-azul);min-width:110px;">Placa de video</span>
                    ...
                    <form action="{{ route('store_pc') }}" method="POST" id="addPcForm"
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" style="font-size:.85rem;" for="en-uso">En uso</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="componentes-no-identificables">
                                <label class="form-check-label" style="font-size:.85rem;" for="componentes-no-identificables">
                        ...
                        <div class="row g-3">
                            <div class="col-auto">
                                <label for="addIdentificador" class="form-label fw-semibold" style="font-size:.85rem;">Nº Inventario</label>
                                <input type="text" class="form-control @error('addIdentificador') is-invalid @enderror"
                            ...
                            <div class="col-auto">
                                ...
                                <input type="text" class="form-control @error('addNombre') is-invalid @enderror"
                                    id="addNombre" name="addNombre" placeholder="Nombre"
                                    style="max-width:165px;" required>
                            </div>
                            <div class="col-auto">
                                <label for="addIp" class="form-label fw-semibold" style="font-size:.85rem;">IPv4</label>
                        ...
                        <div class="row g-3">
                            <div class="col-auto" id="content-container">
                                <div id="area-select">
                                    <label for="addArea" class="form-label fw-semibold" style="font-size:.85rem;">Área</label>
                                    <select class="form-control @error('addArea') is-invalid @enderror"
                                        id="addArea" name="addArea" style="min-width:165px;max-width:165px;" required>
                                    ...
                                    <div class="mt-2" id="addNroConsul_div" style="display:none;">
                                        <label for="addNroConsul" class="form-label fw-semibold" style="font-size:.85rem;">Nº consultorio</label>
                                        <input type="text" class="form-control @error('addNroConsul') is-invalid @enderror"
                            ...
                            <div class="col-auto" id="deposito-select">
                                ...
                                <select class="form-control @error('addDeposito') is-invalid @enderror"
                                    id="addDeposito" name="addDeposito" style="min-width:165px;max-width:165px;" required>
                        ...
                        {{-- Componentes --}}
                        <div id="div-componentes-add" style="display:flex;flex-direction:row;gap:20px;flex-wrap:wrap;">
                            <div style="display:flex;flex-direction:column;gap:20px;">
                                <div class="row g-3">
                                    <div class="col-auto">
                                        <label for="addMotherboard" class="form-label fw-semibold" style="font-size:.85rem;">Placa madre</label>
                                        <select class="form-control @error('addMotherboard') is-invalid @enderror"
                                            id="addMotherboard" name="addMotherboard" style="max-width:165px;" required>
                                            <option value="" disabled selected>Selecciona una placa madre</option>
                                    ...
                                    <div class="col-auto">
                                        <label for="addProcesador" class="form-label fw-semibold" style="font-size:.85rem;">Procesador</label>
                                        <select class="form-control @error('addProcesador') is-invalid @enderror"
                                            id="addProcesador" name="addProcesador" style="max-width:165px;" required>
                                ...
                                <div class="row g-3">
                                    <div class="col-auto">
                                        <label for="addPlacavid" class="form-label fw-semibold" style="font-size:.85rem;">Placa de video</label>
                                        <select class="form-control @error('addPlacavid') is-invalid @enderror"
                                            id="addPlacavid" name="addPlacavid" style="max-width:165px;">
                                            <option value="" disabled selected>Selecciona una placa de video</option>
                                    ...
                                    <div class="col-auto">
                                        <label for="addFuente" class="form-label fw-semibold" style="font-size:.85rem;">Fuente</label>
                                ...
                                <div id="input-container-1">
                                    <div class="form-group input-group mb-3">
                                        <select id="discos1-1" name="discos1[]" class="form-control"
                                            style="border-top-left-radius:5px;border-bottom-left-radius:5px;max-width:165px;" required>
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-hu-outline add-input-disc" type="button">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="material-container-1">
                                    <div class="form-group input-group mb-3">
                                        <select id="rams1-1" name="rams1[]" class="form-control"
                                            ...
                                            @foreach ($rams as $ram)
                                                <option value="{{ $ram->id }}" data-stock="{{ $ram->stock }}">
            ...
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                ...
                <div class="modal-body">
                    <form action="{{ route('edit_pc') }}" method="POST" id="editPcForm"
                        ...
                        <div class="row g-3">
                            <div class="col-auto">
                                <label for="editIdentificador" class="form-label fw-semibold" style="font-size:.85rem;">Nº Inventario</label>
                                <input type="text" class="form-control @error('editIdentificador') is-invalid @enderror"
                                    id="editIdentificador" name="editIdentificador" style="max-width:165px;" required>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="col-auto">
                                <label for="editIp" class="form-label fw-semibold" style="font-size:.85rem;">IPv4</label>
                        ...
                        <div class="row g-3">
                            <div class="col-auto" id="edit-content-container">
                                <div id="edit-area-select">
                                    <label for="editArea" class="form-label fw-semibold" style="font-size:.85rem;">Área</label>
                                    <select class="form-control @error('editArea') is-invalid @enderror"
                                        id="editArea" name="editArea" style="min-width:165px;max-width:165px;" required>
                                        <option value="" disabled selected>Selecciona un área</option>
                                        @foreach ($areas as $area)
                                            <option value="{{ $area->id }}">{{ $area->nombre }}</option>
                                        @endforeach
                                    ...
                                    <div class="mt-2" id="editNroConsul_div" style="display:none;">
                                        <label for="editNroConsul" class="form-label fw-semibold" style="font-size:.85rem;">Nº consultorio</label>
                            ...
                            <div class="col-auto">
                                <label for="editDeposito" class="form-label fw-semibold" style="font-size:.85rem;">Depósito</label>
                                <select class="form-control @error('editDeposito') is-invalid @enderror"
                                    id="editDeposito" name="editDeposito" style="min-width:165px;max-width:165px;" required>
                                    <option value="" disabled selected>Selecciona un depósito</option>
                                    @foreach ($depositos as $deposito)
                                        <option value="{{ $deposito->id }}">{{ $deposito->nombre }}</option>
                                    @endforeach
                        ...
                        <div style="display:flex;flex-direction:row;gap:20px;flex-wrap:wrap;">
                            <div style="display:flex;flex-direction:column;gap:20px;">
                                <div class="row g-3">
                                    <div class="col-auto">
                                        <label for="editMotherboard" class="form-label fw-semibold" style="font-size:.85rem;">Placa madre</label>
                                        <select class="form-control @error('editMotherboard') is-invalid @enderror"
                                            id="editMotherboard" name="editMotherboard" style="max-width:165px;" required>
                                            <option value="" disabled selected>Selecciona una placa madre</option>
                                            @foreach ($motherboards as $motherboard)
                                                <option value="{{ $motherboard->id }}">
                                                    {{ $motherboard->nombre . ' - ' . ($motherboard->deposito->nombre ?? 'no asignado') }}
                                    ...
                                    <div class="col-auto">
                                        <label for="editProcesador" class="form-label fw-semibold" style="font-size:.85rem;">Procesador</label>
                                        <select class="form-control @error('editProcesador') is-invalid @enderror"
                                            id="editProcesador" name="editProcesador" style="max-width:165px;" required>
                                            <option value="" disabled selected>Selecciona un procesador</option>
                                            @foreach ($procesadores as $procesador)
                                                <option value="{{ $procesador->id }}">
                                                    {{ $procesador->nombre . ' - ' . ($procesador->deposito->nombre ?? 'no asignado') }}
                                ...
                                <div class="row g-3">
                                    <div class="col-auto">
                                        <label for="editPlacavid" class="form-label fw-semibold" style="font-size:.85rem;">Placa de video</label>
                                    ...
                                    <div class="col-auto">
                                        <label for="editFuente" class="form-label fw-semibold" style="font-size:.85rem;">Fuente</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" style="font-size:.85rem;" for="en-uso-mantenimineto">Se realizó mantenimiento</label>
                        </div>
                        <div id="div-detalle-mant">
                            <div class="mb-3" style="display:none;">
                                <label for="editDetalle" class="form-label fw-semibold" style="font-size:.85rem;">Detalle</label>
                                <input type="text" class="form-control @error('editDetalle') is-invalid @enderror"
                                    id="editDetalle" name="editDetalle">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="editMotivo" class="form-label fw-semibold" style="font-size:.85rem;">Motivo</label>
                    ...
                    <div class="pc-card"
                        ...
                        onmouseleave="this.style.boxShadow='none';this.style.transform='none'">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <span class="material-symbols-outlined" style="font-size:32px;color:var(--hu-azul);">computer</span>
                                <span class="badge" style="background:{{ $pc->area_id ? '#D1FAE5' : '#FEF3C7' }};color:{{ $pc->area_id ? '#065F46' : '#92400E' }};font-size:.7rem;font-weight:600;border-radius:6px;">
                                    {{ $pc->area_id ? 'En uso' : 'Depósito' }}
                                </span>
                            </div>

                            <div class="flex-grow-1">
                                <div class="fw-semibold" style="font-size:.9rem;color:var(--hu-azul);line-height:1.2;">{{ $pc->nombre }}</div>
                                <div style="font-size:.78rem;color:var(--hu-texto);"><span class="text-muted">Inv:</span> {{ $pc->identificador }}</div>
                                <div style="font-size:.78rem;color:var(--hu-texto);"><span class="text-muted">IP:</span> {{ $pc->ip ?? '—' }}</div>
                                @if ($pc->area_id)
                                    <div style="font-size:.78rem;color:var(--hu-texto);"><span class="text-muted">Área:</span> {{ $pc->area->nombre ?? '—' }}</div>
                                @else
                                    <div style="font-size:.78rem;color:var(--hu-texto);"><span class="text-muted">Depósito:</span> {{ $pc->deposito->nombre ?? '—' }}</div>
                                @endif
                            </div>

                            <div class="d-flex gap-1 mt-auto pt-2">
                                <button class="btn btn-hu btn-sm flex-fill infoBtn"
                                ...
                                @if (Auth::user()->rol->nombre == 'Administrador' ||
                                        Auth::user()->rol->nombre == 'Super administrador' ||
                                        Auth::user()->rol->nombre == 'Tecnico')
                                    <button class="btn btn-hu btn-sm flex-fill maintenanceBtn"
                                ...
                                <button class="btn btn-hu btn-sm flex-fill historyBtn"
    ...
    $(document).ready(function () {
        ...
        $('#editPcModal').on('show.bs.modal', function (event) {
            ...
            ['#editMotherboard','#editProcesador','#editFuente','#editPlacavid'].forEach(function(sel) {
                modal.find(sel + ' option').each(function () {
                    if ($(this).text().endsWith(' - Actual')) { $(this).remove(); }
                });
            });
        ...
        function updateOptionsDisc() {
            ...
            $('select[name="discos1[]"]').each(function () {
                ...
                currentSelect.find('option').each(function () {
                    let v = $(this).val();
                    if (v !== '' && (stock[v] || 0) > 0) { hasOpts = true; anyAvail = true; }
                    else if (v !== '') { $(this).hide(); }
                });
        ...
        $(document).on('click', '.remove-input-disc', function () { $(this).closest('.input-group').remove(); updateOptionsDisc(); });
        $(document).on('click', '.add-input-disc', function () { setTimeout(updateOptionsDisc, 0); });
        updateOptionsDisc();
        ...
        function updateOptionsRam() {
            ...
            $('select[name="rams1[]"] option').each(function () {
                let v = $(this).val(); let s = parseInt($(this).data('stock')) || 0; stock[v] = s;
            });
            $('select[name="rams1[]"]').each(function () {
                let sel = $(this).val(); if (sel) stock[sel] = (stock[sel] || 0) - 1;
            });
            let anyAvail = false;
            $('select[name="rams1[]"]').each(function () {
                let currentSelect = $(this); let hasOpts = false;
                let def = currentSelect.find('option[value=""]');
                currentSelect.find('option').show();
                currentSelect.find('option').each(function () {
                    let v = $(this).val();
            ...
            if (!anyAvail) { $('select[name="rams1[]"] option[value=""]').text('No hay RAMs disponibles'); }
            else { $('select[name="rams1[]"] option[value=""]').text('Selecciona una RAM'); }
        }
        $(document).on('change', 'select[name="rams1[]"]', updateOptionsRam);
        $(document).on('click', '.remove-input-ram', function () { $(this).closest('.input-group').remove(); updateOptionsRam(); });
        $(document).on('click', '.add-input-ram', function () { setTimeout(updateOptionsRam, 0); });
        updateOptionsRam();
        ...
        $(document).on('click', '.remove-input-disc-modal2', function () { $(this).closest('.input-group').remove(); updateOptionsDiscModal2(); });
        $(document).on('click', '.add-input-disc-modal2', function () { setTimeout(updateOptionsDiscModal2, 0); });
        ...
        $(document).on('click', '.remove-input-ram-modal2', function () { $(this).closest('.input-group').remove(); updateOptionsRamModal2(); });
        $(document).on('click', '.add-input-ram-modal2', function () { setTimeout(updateOptionsRamModal2, 0); });

        window.updateRams   = function () { updateOptionsRamModal2(); };
        window.updateDiscos = function () { updateOptionsDiscModal2(); };
        ...
        $('#historyPcModal').on('show.bs.modal', function (event) {
            ...
            $.ajax({
                url: historiaUrl, method: 'GET',
                success: function (response) {
                    var data = [];
                    response.historia.forEach(function (h) {
                        var fecha = new Date(h.created_at).toLocaleDateString('es-ES', {
                ...
                error: function () { alert('Error al cargar la historia.'); }
            });
        });

        $('#historyPcModal').on('hide.bs.modal', function () { modalHandlerAttached = false; });
        ...
        $('#table_historias_pc').DataTable({
            ...
            buttons: [{
                ...
                title: function () { return 'Historia de ' + nro_inv + ' - ' + nombre; }
            }],
            responsive: true,
            lengthChange: true,
            autoWidth: true,
