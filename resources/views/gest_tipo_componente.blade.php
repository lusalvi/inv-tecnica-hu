<x-app-layout>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                <div class="modal-header border-0">
                    <h5 class="modal-title fw-semibold" style="color:var(--hu-azul);">Categorías</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body pt-0 text-muted" style="font-size:.9rem;">
                    Aquí se agregan las categorías de componentes (RAM, Placa madre, Procesador, Periféricos, etc.)
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                <div class="modal-header border-0">
                    <h5 class="modal-title fw-semibold" style="color:var(--hu-azul);">Nueva categoría</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('store_tipo') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-hu w-100">Agregar categoría</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                <div class="modal-header border-0">
                    <h5 class="modal-title fw-semibold" style="color:var(--hu-azul);">Editar categoría</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('edit_tipo') }}" method="POST">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="p-2 rounded-2 mb-3"
                            ...
                            Al cambiar el nombre de la categoría, no podrás encontrar los componentes vinculados a ella
                            al armar una PC o impresora.
                        </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,55,100,.15);">
                <div class="modal-header border-0">
                    <h5 class="modal-title fw-semibold" style="color:var(--hu-azul);">¿Eliminar categoría?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('delete_tipo') }}" method="POST">
                        @csrf
                        ...
                        <div class="p-2 rounded-2 mb-3"
                            ...
                            <span class="material-symbols-outlined"
                                style="font-size:15px;vertical-align:middle;">warning</span>
                            Todos los componentes asociados a esta categoría se desvincularán de la misma.
                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end gap-1">
                                            <button type="button" class="btn btn-hu btn-sm" data-bs-toggle="modal"
                                                ...
                                                data-nombre="{{ $tipo->nombre }}" title="Editar">
                                                <span class="material-symbols-outlined"
                                            ...
                                            @if ($rolActual === 'Super administrador')
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    ...
                                                    data-id="{{ $tipo->id }}" title="Eliminar">
                                                    <span class="material-symbols-outlined"
